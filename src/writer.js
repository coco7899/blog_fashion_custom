...
- 이 뉴스 글 모드에는 제휴 상품 링크와 쇼핑커넥트 고지는 넣지 마세요. 다만 마지막에는 독자가 자신의 반복 습관을 점검하고, 글 내용에 맞는 제품을 기준에 따라 직접 고를 마음이 들도록 생활형 CTA를 쓰세요. 처방약·일반의약품·치료 목적 제품은 추천하지 말고, 식재료·생활용품·기록 도구처럼 비처방 제품만 1개 추천하세요. "무조건 사야 한다"처럼 밀어붙이거나 치료 효과를 약속하지는 마세요.
...
12. 마지막 문단에는 반드시 "이 글에 제휴하면 좋은 제품: **제품명**"을 한 번 넣고, 왜 이 제품이 생활 실천에 도움이 되는지 한 문장으로 설명하세요. 링크·가격·할인·구매 후기·치료 효과는 쓰지 마세요. 측정 도구를 추천할 때는 진단·처방을 대신하지 않는다는 점을 함께 밝히세요.
...
다음 JSON 형식으로만 출력:
{
  ...
  "blocks": [
    ...
    {"type": "paragraph", "text": "오늘 바로 점검할 한 가지와 생활에 맞게 준비하거나 고를 기준을 연결합니다. 이 글에 제휴하면 좋은 제품: **글 주제와 직접 연결되는 비처방 제품 1개**. 제품이 생활 실천에 쓰이는 이유와 필요한 안전 안내를 덧붙여 마무리합니다."}
  ]
}
...
const NEWS_AFFILIATE_RE = /이s*글에s*제휴하면s*좋은s*제품\s*[:：]/;
